...
import { PiMagnifyingGlassFill, PiMagnifyingGlass, PiGlobeSimpleBold } from 'react-icons/pi';

const Sidebar = () => {
    return (
        <aside className='flex flex-col w-[420px] gap-2 '>
            <div className='flex flex-col gap-5 bg-primary-bg rounded-lg py-4 px-5'>
                <SpotifyLogo />
                ...
                <div className='text-[0.65rem] text-secondary-text leading-8 font-semibold'>
                    <div className='flex flex-col   my-8 px-6 '>
                        <div className='flex flex-wrap'>
                            ...
                            <div className='mr-4'>
                                <a href='#' className='mb-2' >Privacy Center</a>
                            </div>
                            <div className='mr-4'>
                                <a href='#' className='mb-2' >Privacy Policy</a>
                            </div>
                            <div className='mr-4'>
                                <a href='#' className='mb-2' >Cookies</a>
                            </div>
                            <div className='mr-4'>
                                <a href='#' className='mb-2' >About Ads</a>
                            </div>
                            <div className='mr-4'>
                                <a href='#' className='mb-2' >Accessibility</a>
                            </div>
